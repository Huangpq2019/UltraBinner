...
input_dir="/path/marine_gold_assembly/input"
assembly="${input_dir}/strmgCAMI2_short_read_pooled_megahit_assembly_f1k.fa"
mapdir="${input_dir}/map"
short_read_dir="/path/marine_gold_assembly/input/sr"
pb_read_dir="/path/marine_gold_assembly/input/pb"
scripts_code_dir="/path/scripts"
...
perl -pe "s/,/\t/g;" ${input_dir}/coverage.tsv > ${input_dir}/coverage_f1k_sr.tsv
