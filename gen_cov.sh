...
input_dir="/path/marine_megahit_assembly/input"
assembly="${input_dir}/marmgCAMI2_short_read_pooled_gold_standard_assembly.fasta"
mapdir="${input_dir}/map"
short_read_dir="/path/marine_megahit_assembly/input/sr"
pb_read_dir="/path/marine_megahit_assembly/input/pb"
